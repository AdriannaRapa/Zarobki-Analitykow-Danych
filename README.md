Projekt koncentruje się na analizie wynagrodzeń w branży analityki danych, wykorzystując dane pozyskane z platformy Kaggle. Analiza została przeprowadzona przy użyciu języka R w środowisku RStudio. 
